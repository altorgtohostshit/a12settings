...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    public <UT, UB> UB parseExtension(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        ...
        if (!generatedExtension.descriptor.isRepeated() || !generatedExtension.descriptor.isPacked()) {
            ...
            if (generatedExtension.getLiteType() != WireFormat.FieldType.ENUM) {
                switch (C19571.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                    case 1:
            ...
            if (generatedExtension.isRepeated()) {
                ...
                int i = C19571.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()];
    ...
    static /* synthetic */ class C19571 {
        ...
        static {
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.ExtensionSchemaLite.C19571.<clinit>():void");
        }
    }
    ...
    public void serializeExtension(Writer writer, Map.Entry<?, ?> entry) throws IOException {
        ...
        if (extensionDescriptor.isRepeated()) {
            switch (C19571.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extensionDescriptor.getLiteType().ordinal()]) {
                case 1:
