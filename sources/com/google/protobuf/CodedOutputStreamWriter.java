    ...
    static /* synthetic */ class C19561 {
        ...
        static {
            ...
            L_0x0090:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.CodedOutputStreamWriter.C19561.<clinit>():void");
        }
    }

    private <K, V> void writeDeterministicMap(int i, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) throws IOException {
        int[] iArr = C19561.$SwitchMap$com$google$protobuf$WireFormat$FieldType;
        throw null;
    }
}
