    ...
    static /* synthetic */ class C19761 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C19761.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C19761.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
