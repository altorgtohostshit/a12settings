...
public class PartnerCustomizationLayout extends TemplateLayout {
    ...
    public void onBeforeTemplateInflated(AttributeSet attributeSet, int i) {
        ...
        if (Log.isLoggable("PartnerCustomizedLayout", 3)) {
            Log.d("PartnerCustomizedLayout", "activity=" + this.activity.getClass().getSimpleName() + " isSetupFlow=" + isAnySetupWizard + " enablePartnerResourceLoading=" + enablePartnerResourceLoading() + " usePartnerResourceAttr=" + this.usePartnerResourceAttr + " useDynamicColor=" + this.useDynamicColor + " useFullDynamicColorAttr=" + this.useFullDynamicColorAttr);
        }
    }
