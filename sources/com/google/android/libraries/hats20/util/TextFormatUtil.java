...
public class TextFormatUtil {
    ...
    private static void addAndFormatTextToOutput(SpannableStringBuilder spannableStringBuilder, WordMatch wordMatch) {
        ...
        if (charAt == '*' || charAt == '_') {
            ...
            int i2 = (wordMatch.end - wordMatch.start) - 2;
            if (charAt != '*') {
                i = 2;
            }
            spannableStringBuilder.setSpan(new StyleSpan(i), spannableStringBuilder.length() - i2, spannableStringBuilder.length(), 33);
            return;
        }
