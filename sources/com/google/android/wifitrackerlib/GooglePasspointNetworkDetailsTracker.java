...
public class GooglePasspointNetworkDetailsTracker extends PasspointNetworkDetailsTracker {
    private final WsuNetworkDetailsController mWsuNetworkDetailsController;

    public GooglePasspointNetworkDetailsTracker(Lifecycle lifecycle, Context context, WifiManager wifiManager, ConnectivityManager connectivityManager, NetworkScoreManager networkScoreManager, Handler handler, Handler handler2, Clock clock, long j, long j2, String str) {
