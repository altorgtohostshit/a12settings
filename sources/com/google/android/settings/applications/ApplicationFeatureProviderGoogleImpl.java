...
public class ApplicationFeatureProviderGoogleImpl extends ApplicationFeatureProviderImpl {
        ...
        try {
            ...
            if (call != null) {
                if (call.getBoolean("success")) {
                    ...
                    return this.mContext.getString(R.string.screen_time_summary_usage_today, new Object[]{readableDuration});
                }
            }
            if (DEBUG) {
    ...
    public String getReadableDuration(Long l, MeasureFormat.FormatWidth formatWidth, int i, boolean z) {
        long j;
        long j2;
