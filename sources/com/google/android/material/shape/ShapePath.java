...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f116x = f;
        float unused2 = pathLineOperation.f117y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f117y - this.startY), (double) (this.operation.f116x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f117y - this.startY) / (this.operation.f116x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f116x, this.f117y);
