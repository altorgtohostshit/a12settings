...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    static /* synthetic */ class C19101 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.AbstractIterator.C19101.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C19101.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
