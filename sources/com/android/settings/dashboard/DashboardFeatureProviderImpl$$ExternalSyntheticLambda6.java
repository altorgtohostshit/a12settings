...
public final /* synthetic */ class DashboardFeatureProviderImpl$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ DashboardFeatureProviderImpl$$ExternalSyntheticLambda6(DashboardFeatureProviderImpl dashboardFeatureProviderImpl, Uri uri, Preference preference) {
    ...
    public final void run() {
        this.f$0.lambda$refreshTitle$2(this.f$1, this.f$2);
    }
}
