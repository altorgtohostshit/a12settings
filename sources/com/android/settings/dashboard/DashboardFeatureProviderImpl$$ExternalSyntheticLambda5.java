...
public final /* synthetic */ class DashboardFeatureProviderImpl$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ DashboardFeatureProviderImpl$$ExternalSyntheticLambda5(DashboardFeatureProviderImpl dashboardFeatureProviderImpl, Uri uri, Preference preference) {
    ...
    public final void run() {
        this.f$0.lambda$refreshSwitch$9(this.f$1, this.f$2);
    }
}
