...
class TrustedCredentialsDialogBuilder extends AlertDialog.Builder {
    ...
    private void initDefaultBuilderParams() {
        ...
        setPositiveButton((int) R.string.trusted_credentials_trust_label, (DialogInterface.OnClickListener) null);
    ...
    private static class DialogEventHandler implements DialogInterface.OnShowListener, View.OnClickListener {
        ...
        private void onClickTrust() {
            ...
            if (!this.mDelegate.startConfirmCredentialIfNotConfirmed(currentCertInfo.getUserId(), new C0584xaae824fd(this))) {
        ...
        private void onClickEnableOrDisable() {
            ...
            C05801 r1 = new DialogInterface.OnClickListener() {
            ...
            if (currentCertInfo.isSystemCert()) {
                ...
                new AlertDialog.Builder(this.mActivity).setMessage((int) R.string.trusted_credentials_remove_confirmation).setPositiveButton(17039379, (DialogInterface.OnClickListener) r1).setNegativeButton(17039369, (DialogInterface.OnClickListener) null).show();
            }
        }
        ...
        private static int getButtonLabel(TrustedCredentialsSettings.CertHolder certHolder) {
            if (certHolder.isSystemCert()) {
                return certHolder.isDeleted() ? R.string.trusted_credentials_enable_label : R.string.trusted_credentials_disable_label;
            }
