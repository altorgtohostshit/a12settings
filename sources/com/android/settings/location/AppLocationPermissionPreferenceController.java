...
public class AppLocationPermissionPreferenceController extends LocationBasePreferenceController implements PreferenceControllerMixin {
    ...
    public CharSequence getSummary() {
        ...
        return resources.getQuantityString(R.plurals.location_app_permission_summary_location_on, i, new Object[]{Integer.valueOf(i), Integer.valueOf(this.mNumTotal)});
    }
        ...
        if (this.mLocationManager.isLocationEnabled() && this.loadingInProgress.get() == 0) {
            ...
            for (UserHandle identifier : userProfiles) {
                ...
                if (createPackageContextAsUser == null) {
                    ...
                    permissionControllerManager.countPermissionApps(Arrays.asList(new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION"}), 0, new C0996xdc12bf8b(this), (Handler) null);
                    permissionControllerManager.countPermissionApps(Arrays.asList(new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION"}), 1, new C0997xdc12bf8c(this), (Handler) null);
                }
            }
        }
    }
