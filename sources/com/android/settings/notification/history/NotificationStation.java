...
public class NotificationStation extends SettingsPreferenceFragment {
    ...
    private CharSequence generateExtraText(StatusBarNotification statusBarNotification, HistoricalNotificationInfo historicalNotificationInfo) {
        ...
        spannableStringBuilder.append("\n").append(bold(getString(R.string.notification_log_details_parcel))).append(string).append(String.valueOf(obtain.dataPosition())).append(' ').append(bold(getString(R.string.notification_log_details_ashmem))).append(string).append(String.valueOf(obtain.getBlobAshmemSize())).append("\n");
        return spannableStringBuilder;
    }
    ...
    private static class HistoricalNotificationPreference extends Preference {
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            preferenceViewHolder.findViewById(R.id.timestamp).setOnLongClickListener(new C1120xd404025a(this, preferenceViewHolder));
        }
