...
public class ShowOnLockScreenNotificationPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, Preference.OnPreferenceChangeListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        String string = this.mContext.getString(R.string.lock_screen_notifs_show_all);
        String num = Integer.toString(R.string.lock_screen_notifs_show_all);
        arrayList.add(string);
        arrayList2.add(num);
        setRestrictedIfNotificationFeaturesDisabled(restrictedListPreference, string, num, 4);
        String string2 = this.mContext.getString(R.string.lock_screen_notifs_show_alerting);
        String num2 = Integer.toString(R.string.lock_screen_notifs_show_alerting);
        arrayList.add(string2);
        arrayList2.add(num2);
        setRestrictedIfNotificationFeaturesDisabled(restrictedListPreference, string2, num2, 4);
        arrayList.add(this.mContext.getString(R.string.lock_screen_notifs_show_none));
        arrayList2.add(Integer.toString(R.string.lock_screen_notifs_show_none));
        ...
        if (!adminAllowsNotifications() || !getLockscreenNotificationsEnabled()) {
            restrictedListPreference.setValue(Integer.toString(R.string.lock_screen_notifs_show_none));
        } else if (!getLockscreenSilentNotificationsEnabled()) {
            restrictedListPreference.setValue(Integer.toString(R.string.lock_screen_notifs_show_alerting));
        } else {
            restrictedListPreference.setValue(Integer.toString(R.string.lock_screen_notifs_show_all));
        }
