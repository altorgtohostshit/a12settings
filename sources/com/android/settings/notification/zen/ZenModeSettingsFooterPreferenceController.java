...
public class ZenModeSettingsFooterPreferenceController extends AbstractZenModePreferenceController {
    ...
    public static class ZenCustomSettingsDialog extends InstrumentedDialogFragment {
        ...
        public int getAllowRes(boolean z) {
            return z ? R.string.zen_mode_sound_summary_on : R.string.zen_mode_sound_summary_off;
        }
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            final AlertDialog create = new AlertDialog.Builder(activity).setTitle((int) R.string.zen_custom_settings_dialog_title).setNeutralButton(R.string.zen_custom_settings_dialog_review_schedule, new DialogInterface.OnClickListener() {
            ...
            }).setPositiveButton((int) R.string.zen_custom_settings_dialog_ok, (DialogInterface.OnClickListener) null).setView(LayoutInflater.from(activity).inflate(activity.getResources().getLayout(R.layout.zen_custom_settings_dialog), (ViewGroup) null, false)).create();
