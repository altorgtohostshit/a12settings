...
public abstract class AppCounter extends AsyncTask<Void, Void, Integer> {
    ...
    public Integer doInBackground(Void... voidArr) {
        ...
        for (UserInfo userInfo : this.mUm.getProfiles(UserHandle.myUserId())) {
            for (ApplicationInfo includeInCount : this.mPm.getInstalledApplicationsAsUser(33280 | (userInfo.isAdmin() ? 4194304 : 0), userInfo.id)) {
                if (includeInCount(includeInCount)) {
                    i++;
                }
            }
        }
