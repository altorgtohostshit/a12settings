    ...
    public void refreshUi(boolean z) {
        ...
        synchronized (this.mState.mLock) {
            ...
            if (!(this.mCurTotalRam == totalSize && this.mCurHighRam == j3 && this.mCurMedRam == j && this.mCurLowRam == j2)) {
                ...
                this.mBackgroundProcessText.setText(getResources().getString(R.string.running_processes_header_ram, new Object[]{unicodeWrap}));
                String unicodeWrap2 = instance.unicodeWrap(Formatter.formatShortFileSize(getContext(), j));
                this.mAppsProcessText.setText(getResources().getString(R.string.running_processes_header_ram, new Object[]{unicodeWrap2}));
                String unicodeWrap3 = instance.unicodeWrap(Formatter.formatShortFileSize(getContext(), j3));
                this.mForegroundProcessText.setText(getResources().getString(R.string.running_processes_header_ram, new Object[]{unicodeWrap3}));
