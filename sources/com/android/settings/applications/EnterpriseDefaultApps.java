...
public enum EnterpriseDefaultApps {
    BROWSER(new Intent[]{buildIntent("android.intent.action.VIEW", "android.intent.category.BROWSABLE", "http:", (String) null)}),
    CALENDAR(new Intent[]{buildIntent("android.intent.action.INSERT", (String) null, (String) null, "vnd.android.cursor.dir/event")}),
    CAMERA(new Intent[]{new Intent("android.media.action.IMAGE_CAPTURE"), new Intent("android.media.action.VIDEO_CAPTURE")}),
    CONTACTS(new Intent[]{buildIntent("android.intent.action.PICK", (String) null, (String) null, "vnd.android.cursor.dir/contact")}),
    ...
    MAP(new Intent[]{buildIntent("android.intent.action.VIEW", (String) null, "geo:", (String) null)}),
