...
public class ProcessStatsDetail extends SettingsPreferenceFragment {
    ...
    private void showStopServiceDialog(final String str, final String str2) {
        new AlertDialog.Builder(getActivity()).setTitle((int) R.string.runningservicedetails_stop_dlg_title).setMessage((int) R.string.runningservicedetails_stop_dlg_text).setPositiveButton((int) R.string.dlg_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                ProcessStatsDetail.this.doStopService(str, str2);
            }
        }).setNegativeButton((int) R.string.dlg_cancel, (DialogInterface.OnClickListener) null).show();
    }
