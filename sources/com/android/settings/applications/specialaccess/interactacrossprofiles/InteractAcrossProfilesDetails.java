...
public class InteractAcrossProfilesDetails extends AppInfoBase implements Preference.OnPreferenceClickListener {
    ...
    private void showConsentDialog() {
        ...
        new AlertDialog.Builder(getActivity()).setView(inflate).setPositiveButton((int) R.string.allow, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        }).setNegativeButton((int) R.string.deny, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private boolean refreshUiForNonConfigurableApps() {
        ...
        this.mSwitchPref.setTitle((int) R.string.interact_across_profiles_switch_disabled);
        if (!isCrossProfilePackageAllowlisted(this.mPackageName)) {
        ...
        if (!z) {
            this.mInstallBanner.setTitle((CharSequence) getString(R.string.interact_across_profiles_install_personal_app_title, this.mAppLabel));
            if (this.mInstallAppIntent != null) {
                this.mInstallBanner.setSummary((int) R.string.interact_across_profiles_install_app_summary);
            }
            ...
            this.mInstallBanner.setTitle((CharSequence) getString(R.string.interact_across_profiles_install_work_app_title, this.mAppLabel));
            if (this.mInstallAppIntent != null) {
                this.mInstallBanner.setSummary((int) R.string.interact_across_profiles_install_app_summary);
            }
            this.mInstallBanner.setVisible(true);
    ...
    private void enableSwitchPref() {
        ...
        this.mSwitchPref.setTitle((int) R.string.interact_across_profiles_switch_enabled);
