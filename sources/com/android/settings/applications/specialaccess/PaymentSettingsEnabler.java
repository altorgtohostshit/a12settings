...
public class PaymentSettingsEnabler extends BaseNfcEnabler {
    ...
    public void handleNfcStateChanged(int i) {
        if (i == 1) {
            this.mPreference.setSummary((int) R.string.nfc_and_payment_settings_payment_off_nfc_off_summary);
            ...
            this.mPreference.setSummary((int) R.string.nfc_and_payment_settings_no_payment_installed_summary);
            this.mPreference.setEnabled(false);
        }
    }
