...
public class CachedStorageValuesHelper {
    ...
    public SparseArray<StorageAsyncLoader.AppsStorageResult> getCachedAppsStorageResult() {
        ...
        long j7 = j6;
        long j8 = this.mSharedPreferences.getLong("external_total_bytes", -1);
        long j9 = this.mSharedPreferences.getLong("external_audio_bytes", -1);
        long j10 = this.mSharedPreferences.getLong("external_video_bytes", -1);
        long j11 = this.mSharedPreferences.getLong("external_image_bytes", -1);
        long j12 = this.mSharedPreferences.getLong("external_apps_bytes", -1);
        if (j8 < 0 || j9 < 0 || j10 < 0 || j11 < 0 || j12 < 0) {
            return null;
        }
        StorageStatsSource.ExternalStorageStats externalStorageStats = new StorageStatsSource.ExternalStorageStats(j8, j9, j10, j11, j12);
        ...
        appsStorageResult.cacheSize = j7;
