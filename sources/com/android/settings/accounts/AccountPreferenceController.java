...
public class AccountPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, AuthenticatorHelper.OnAccountsUpdateListener, Preference.OnPreferenceClickListener, LifecycleObserver, OnPause, OnResume {
    ...
    private void updateProfileUi(UserInfo userInfo) {
        ...
        if (this.mFragment.getPreferenceManager() != null) {
            ...
            if (isSingleProfile()) {
                createAccessiblePreferenceCategory.setTitle((CharSequence) context.getString(R.string.account_for_section_header, new Object[]{BidiFormatter.getInstance().unicodeWrap(userInfo.name)}));
                createAccessiblePreferenceCategory.setContentDescription(this.mContext.getString(R.string.account_settings));
            } else if (userInfo.isManagedProfile()) {
                if (this.mType == 3) {
                    createAccessiblePreferenceCategory.setTitle((int) R.string.category_work);
                    ...
                    createAccessiblePreferenceCategory.setContentDescription(this.mContext.getString(R.string.accessibility_category_work, new Object[]{workGroupSummary}));
                }
                ...
                createAccessiblePreferenceCategory.setTitle((int) R.string.category_personal);
            ...
            if (preferenceScreen == null) {
                ...
                preferenceGroup = (PreferenceGroup) preferenceScreen.findPreference("accounts_category");
            }
            if (preferenceGroup != null) {
                preferenceGroup.addPreference(createAccessiblePreferenceCategory);
            }
    ...
    private RestrictedPreference newAddAccountPreference() {
        ...
        restrictedPreference.setTitle((int) R.string.add_account_label);
        restrictedPreference.setIcon((int) R.drawable.ic_add_24dp);
    ...
    private RestrictedPreference newRemoveWorkProfilePreference() {
        ...
        restrictedPreference.setTitle((int) R.string.remove_managed_profile_label);
        restrictedPreference.setIcon((int) R.drawable.ic_delete);
        restrictedPreference.setOnPreferenceClickListener(this);
    ...
    private String getWorkGroupSummary(Context context, UserInfo userInfo) {
        ...
        return this.mContext.getString(R.string.managing_admin, new Object[]{applicationLabel});
    }
