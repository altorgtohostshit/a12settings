...
public class BatterySaverScheduleSeekBarController implements Preference.OnPreferenceChangeListener {
    ...
    public BatterySaverScheduleSeekBarController(Context context) {
        ...
        seekBarPreference.setLayoutResource(R.layout.battery_saver_schedule_percentage_seekbar);
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        preference.setTitle((CharSequence) this.mContext.getString(R.string.battery_saver_seekbar_title, new Object[]{Utils.formatPercentage(intValue)}));
        return true;
    }
    ...
    public void updateSeekBar() {
        ...
        if (Settings.Global.getInt(contentResolver, "automatic_power_save_mode", 0) == 0) {
            ...
            this.mSeekBarPreference.setTitle((CharSequence) this.mContext.getString(R.string.battery_saver_seekbar_title, new Object[]{Utils.formatPercentage(max * 5)}));
            return;
        }
        this.mSeekBarPreference.setVisible(false);
    }
