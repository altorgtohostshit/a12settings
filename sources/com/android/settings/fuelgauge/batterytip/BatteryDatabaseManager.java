...
public class BatteryDatabaseManager {
    ...
    public synchronized List<AppInfo> queryAllAnomalies(long j, int i) {
        ...
        Cursor query = this.mDatabaseHelper.getReadableDatabase().query("anomaly", new String[]{"package_name", "anomaly_type", "uid"}, "time_stamp_ms > ? AND anomaly_state = ? ", new String[]{String.valueOf(j), String.valueOf(i)}, (String) null, (String) null, "time_stamp_ms DESC");
