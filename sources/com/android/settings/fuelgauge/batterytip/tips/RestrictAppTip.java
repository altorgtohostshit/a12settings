...
public class RestrictAppTip extends BatteryTip {
    ...
    public CharSequence getSummary(Context context) {
        int size = this.mRestrictAppList.size();
        return context.getResources().getQuantityString(this.mState == 1 ? R.plurals.battery_tip_restrict_handled_summary : R.plurals.battery_tip_restrict_summary, size, new Object[]{size > 0 ? Utils.getApplicationLabel(context, this.mRestrictAppList.get(0).packageName) : "", Integer.valueOf(size)});
    }
