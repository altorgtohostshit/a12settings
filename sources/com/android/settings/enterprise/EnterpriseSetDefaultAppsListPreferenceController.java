...
public class EnterpriseSetDefaultAppsListPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    private void buildAppList() {
        ...
        ThreadUtils.postOnMainThread(new C0916xb9e1e136(this));
    }
            ...
            if (this.mEnterprisePrivacyFeatureProvider.isInCompMode() || this.mUsers.size() != 1) {
                for (int i = 0; i < this.mUsers.size(); i++) {
                    ...
                    if (this.mUsers.get(i).isManagedProfile()) {
                        preferenceCategory.setTitle((int) R.string.category_work);
                    } else {
                        preferenceCategory.setTitle((int) R.string.category_personal);
                    }
    ...
    static /* synthetic */ class C09151 {
        ...
        static final /* synthetic */ int[] f63x4783f43a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f63x4783f43a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f63x4783f43a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f63x4783f43a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f63x4783f43a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f63x4783f43a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f63x4783f43a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.enterprise.EnterpriseSetDefaultAppsListPreferenceController.C09151.<clinit>():void");
        }
    }

    private String getTitle(Context context, EnterpriseDefaultApps enterpriseDefaultApps, int i) {
        switch (C09151.f63x4783f43a[enterpriseDefaultApps.ordinal()]) {
            case 1:
