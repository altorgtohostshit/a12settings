...
public class ChooseLockTypeDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setTitle((int) R.string.setup_lock_settings_options_dialog_title);
    ...
    private static class ScreenLockAdapter extends ArrayAdapter<ScreenLockType> {
        ...
        private static Drawable getIconForScreenLock(Context context, ScreenLockType screenLockType) {
            int i = C12061.$SwitchMap$com$android$settings$password$ScreenLockType[screenLockType.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C12061 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.password.ChooseLockTypeDialogFragment.C12061.<clinit>():void");
        }
    }
}
