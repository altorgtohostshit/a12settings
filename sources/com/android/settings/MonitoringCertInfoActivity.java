...
public class MonitoringCertInfoActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        CharSequence quantityText = getResources().getQuantityText(RestrictedLockUtils.getProfileOrDeviceOwner(this, userHandle) != null ? R.plurals.ssl_ca_cert_settings_button : R.plurals.ssl_ca_cert_dialog_title, intExtra2);
        ...
        if (devicePolicyManager.getProfileOwnerAsUser(this.mUserId) != null) {
            builder.setMessage((CharSequence) getResources().getQuantityString(R.plurals.ssl_ca_cert_info_message, intExtra2, new Object[]{devicePolicyManager.getProfileOwnerNameAsUser(this.mUserId)}));
        } else if (devicePolicyManager.getDeviceOwnerComponentOnCallingUser() != null) {
            builder.setMessage((CharSequence) getResources().getQuantityString(R.plurals.ssl_ca_cert_info_message_device_owner, intExtra2, new Object[]{devicePolicyManager.getDeviceOwnerNameOnAnyUser()}));
        } else {
            builder.setIcon(17301624);
            builder.setMessage((int) R.string.ssl_ca_cert_warning_message);
        }
        builder.show();
    }
