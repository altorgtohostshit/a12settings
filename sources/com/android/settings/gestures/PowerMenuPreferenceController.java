...
public class PowerMenuPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        return this.mContext.getText(R.string.power_menu_long_press_for_assist);
    }

    public int getAvailabilityStatus() {
        return isAssistInvocationAvailable() ? 0 : 2;
    }

    private boolean isAssistInvocationAvailable() {
        return this.mContext.getResources().getBoolean(17891582);
    }
}
