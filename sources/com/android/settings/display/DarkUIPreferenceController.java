...
public class DarkUIPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public void updateEnabledStateIfNeeded() {
        if (this.mPreference != null) {
            ...
            if (isPowerSaveMode) {
                this.mPreference.setSummary((CharSequence) this.mContext.getString(isChecked() ? R.string.dark_ui_mode_disabled_summary_dark_theme_on : R.string.dark_ui_mode_disabled_summary_dark_theme_off));
            }
        }
    }
