...
public final class BluetoothPairingService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        PendingIntent activity = PendingIntent.getActivity(this, 0, getPairingDialogIntent(this, intent, 2), 1275068416);
        PendingIntent broadcast = PendingIntent.getBroadcast(this, 0, new Intent("com.android.settings.bluetooth.ACTION_DISMISS_PAIRING"), 1140850688);
        ...
        if (bluetoothDevice == null || bluetoothDevice.getBondState() == 11) {
            ...
            localOnly.setContentTitle(resources.getString(R.string.bluetooth_notif_title)).setContentText(resources.getString(R.string.bluetooth_notif_message, new Object[]{stringExtra})).setContentIntent(activity).setDefaults(1).setColor(getColor(17170460)).addAction(new Notification.Action.Builder(0, resources.getString(R.string.bluetooth_device_context_pair_connect), activity).build()).addAction(new Notification.Action.Builder(0, resources.getString(17039360), broadcast).build());
