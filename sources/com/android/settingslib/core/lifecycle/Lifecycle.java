...
public class Lifecycle extends LifecycleRegistry {
    ...
    public Lifecycle(LifecycleOwner lifecycleOwner) {
        ...
        LifecycleProxy lifecycleProxy = new LifecycleProxy(this, (C14801) null);
    ...
    private class LifecycleProxy implements LifecycleObserver {
        ...
        /* synthetic */ LifecycleProxy(Lifecycle lifecycle, C14801 r2) {
            this();
        }

        @OnLifecycleEvent(Lifecycle.Event.ON_ANY)
        public void onLifecycleEvent(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            switch (C14801.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
                case 2:
    ...
    static /* synthetic */ class C14801 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.core.lifecycle.Lifecycle.C14801.<clinit>():void");
        }
    }
}
