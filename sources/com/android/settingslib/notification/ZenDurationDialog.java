...
public class ZenDurationDialog {
    ...
    public void setupRadioButtons(int i) {
        ...
        getConditionTagAt(i2).f112rb.setChecked(true);
    }
    ...
    private void bindTag(int i, View view, int i2) {
        ...
        if (conditionTag.f112rb == null) {
            conditionTag.f112rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
        }
        if (i <= 0) {
        ...
        conditionTag.f112rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    conditionTag.f112rb.setChecked(true);
                }
            }
        });
