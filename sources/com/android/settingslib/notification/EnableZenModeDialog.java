...
public class EnableZenModeDialog {
    ...
    public void bind(Condition condition, View view, int i) {
        ...
        if (condition != null) {
            ...
            RadioButton radioButton = conditionTag2.f111rb;
            if (radioButton != null) {
                z = false;
            }
            if (radioButton == null) {
                conditionTag2.f111rb = (RadioButton) this.mZenRadioGroup.getChildAt(i);
            }
            ...
            conditionTag2.f111rb.setEnabled(z2);
            conditionTag2.f111rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    if (z) {
                        conditionTag2.f111rb.setChecked(true);
    ...
    private String foreverSummary(Context context) {
        return context.getString(17041654);
    }
    ...
    private void updateUi(final ConditionTag conditionTag, final View view, Condition condition, boolean z, final int i, Uri uri) {
        ...
        conditionTag.lines.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                conditionTag.f111rb.setChecked(true);
            }
        });
