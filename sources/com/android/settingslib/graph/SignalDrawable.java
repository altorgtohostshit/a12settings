...
public class SignalDrawable extends DrawableWrapper {
    ...
    public SignalDrawable(Context context) {
        super(context.getDrawable(17302837));
        ...
        path.set(PathParser.createPathFromPathData(context.getString(17039992)));
        updateScaledXPath();
        this.mCutoutWidthFraction = context.getResources().getFloat(17105107);
        this.mCutoutHeightFraction = context.getResources().getFloat(17105106);
