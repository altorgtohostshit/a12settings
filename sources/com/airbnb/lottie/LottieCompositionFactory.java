...
public class LottieCompositionFactory {
    ...
    private static LottieResult<LottieComposition> fromJsonInputStreamSync(InputStream inputStream, String str, boolean z) {
        try {
            return fromJsonReaderSync(JsonReader.m7of(Okio.buffer(Okio.source(inputStream))), str);
        } finally {
            if (z) {
        ...
        try {
            ...
            while (nextEntry != null) {
                ...
                if (name.contains("__MACOSX")) {
                    ...
                    lottieComposition = fromJsonReaderSyncInternal(JsonReader.m7of(Okio.buffer(Okio.source(zipInputStream))), (String) null, false).getValue();
                } else {
