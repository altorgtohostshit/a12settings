        ...
        while (true) {
            ...
            if (forModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C05141.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        baseLayer2 = forModel;
                    }
                }
    ...
    static /* synthetic */ class C05141 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.layer.CompositionLayer.C05141.<clinit>():void");
        }
    }

    /* access modifiers changed from: package-private */
    public void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C0478L.beginSection("CompositionLayer#draw");
        ...
        canvas.restore();
        C0478L.endSection("CompositionLayer#draw");
    }
