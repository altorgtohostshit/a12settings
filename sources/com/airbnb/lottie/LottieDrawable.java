...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public LottieDrawable() {
        ...
        C04911 r3 = new ValueAnimator.AnimatorUpdateListener() {
    ...
    public void draw(Canvas canvas) {
        this.isDirty = false;
        C0478L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
                drawInternal(canvas);
            } catch (Throwable th) {
        ...
        C0478L.endSection("Drawable#draw");
    }
