...
class JsonUtils {
    ...
    static /* synthetic */ class C05181 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.JsonUtils.C05181.<clinit>():void");
        }
    }

    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C05181.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C05181.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[peek.ordinal()];
        if (i == 1) {
