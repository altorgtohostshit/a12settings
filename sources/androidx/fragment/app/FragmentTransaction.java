...
public abstract class FragmentTransaction {
    ...
    String mName;
    ArrayList<C0238Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0238Op {
        ...
        C0238Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0238Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0238Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mTopmostFragment = false;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0238Op(3, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0238Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0238Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0238Op(7, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0238Op(10, fragment, state));
        return this;
    }
