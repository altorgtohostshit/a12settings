...
public class ChangeImageTransform extends Transition {
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        ...
        int i = C04283.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C04283 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C04283.<clinit>():void");
        }
    }
