    ...
    static /* synthetic */ class C02734 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.loader.content.ModernAsyncTask.C02734.<clinit>():void");
        }
    }

    public final void executeOnExecutor(Executor executor) {
        if (this.mStatus != Status.PENDING) {
            int i = C02734.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
