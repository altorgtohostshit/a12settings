...
public abstract class Lifecycle {
    ...
    public enum Event {
        ...
        public static Event downFrom(State state) {
            int i = C02601.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
            if (i == 1) {
                return ON_DESTROY;
            }
            if (i == 2) {
        ...
        public State getTargetState() {
            switch (C02601.$SwitchMap$androidx$lifecycle$Lifecycle$Event[ordinal()]) {
                case 1:
                case 2:
    ...
    static /* synthetic */ class C02601 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.Lifecycle.C02601.<clinit>():void");
        }
    }
