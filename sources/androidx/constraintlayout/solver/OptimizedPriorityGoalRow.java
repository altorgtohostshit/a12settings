...
public class OptimizedPriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object obj) {
            return this.variable.f18id - ((SolverVariable) obj).f18id;
        }
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i4 - 1].f18id > solverVariable.f18id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() {
                public int compare(SolverVariable solverVariable, SolverVariable solverVariable2) {
                    return solverVariable.f18id - solverVariable2.f18id;
                }
            });
