...
public class MonotonicCurveFit extends CurveFit {
    ...
    /* renamed from: mT */
    private double[] f11mT;
    private double[][] mTangent;

    /* renamed from: mY */
    private double[][] f12mY;
    ...
    public void getPos(double d, double[] dArr) {
        double[] dArr2 = this.f11mT;
        int length = dArr2.length;
        int i = 0;
        int length2 = this.f12mY[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f12mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f11mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f12mY[i4][i5];
                }
            }
            double[] dArr3 = this.f11mT;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
                double d2 = dArr3[i6] - dArr3[i4];
                double d3 = (d - dArr3[i4]) / d2;
                while (i < length2) {
                    double[][] dArr4 = this.f12mY;
    ...
    public void getPos(double d, float[] fArr) {
        double[] dArr = this.f11mT;
        int length = dArr.length;
        int i = 0;
        int length2 = this.f12mY[0].length;
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f12mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f11mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f12mY[i4][i5];
                }
            }
            double[] dArr2 = this.f11mT;
            int i6 = i4 + 1;
    ...
    public double getPos(double d, int i) {
        ...
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f12mY[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f12mY[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f11mT;
            if (d == dArr2[i2]) {
                return this.f12mY[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
