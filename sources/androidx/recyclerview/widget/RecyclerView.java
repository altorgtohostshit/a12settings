...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C03657.f43x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
            if (i != 2) {
    ...
    static /* synthetic */ class C03657 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f43x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C03657.<clinit>():void");
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C03661 r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            C03672 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
